...
using UnityEngine;
    ...
    public class PersistentDataManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            foreach (var s1 in instance.m_DataPersisters)
        ...
        {
        Debug.Log(instance.m_DataPersisters.Count);
        foreach (var dp in m_DataPersisters)
            {
            Debug.Log(m_DataPersisters);
                Save(dp);
            }
        }
     ...
     public Dictionary<string, Data> m_Storejsonreturn()
    {

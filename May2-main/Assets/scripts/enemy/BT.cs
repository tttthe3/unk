...
namespace BTAI
{
    ...
    public static class BT
    {
        ...
        public static AniChange AniChange(Animator animator, string name, bool set = true) { return new AniChange(animator, name, set); }
    ...
    public class AniChange : BTNode
    {
        ...
        //if set == false, it reset the trigger istead of setting it.
        public AniChange(Animator animator, string name, bool set = true)
        {
            this.id = Animator.StringToHash(name);
            this.animator = animator;
            this.triggerName = name;

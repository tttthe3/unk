...
public class Enemy_dead_type : SceneLinkedSMB<EnemyBehaviour>
{
    ...
    public override void OnSLStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        m_MonoBehaviour.skeletonAnimation.AnimationState.SetAnimation(0, m_MonoBehaviour.Plusstatename+"dead", false);

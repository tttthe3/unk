...
public class Damager : MonoBehaviour
{
    ...
    public bool hitcheckhold = false;
    ...
    {
        if (collision.gameObject.tag == hittername&rengeki)
        {
            hitcheck = true;
            hit = collision;
            EnableDamage();
    ...
    public float Getdamagaebletime()
    {
    ...
    void FixedUpdate() 
    {
        ...
        if (hitcheck)
        {
            ...
            {
                hittimer = damageable.invulnerabilityDuration;

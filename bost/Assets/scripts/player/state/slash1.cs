...
using UnityEngine.Animations;
    ...
    public class slash1 : SceneLinkedSMB<Charactercontrolelr>
    {
    ...
    public Vector3 effecthoise;
        ...
        public override void OnSLStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
        {
            ...
            m_MonoBehaviour.skeletonAnimation.timeScale = 3.9f;
            m_MonoBehaviour.skeletonAnimation.AnimationState.SetAnimation(0, "slash7", false);
            timer = 0f;
        
        Debug.Log(effect1.transform.position);

...
public class Enemy_DamagedDown_type1 : SceneLinkedSMB<EnemyBehaviour>
{
    ...
    public override void OnSLStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        m_MonoBehaviour.skeletonAnimation.AnimationState.SetAnimation(0, m_MonoBehaviour.Plusstatename+"damaged2", false);
